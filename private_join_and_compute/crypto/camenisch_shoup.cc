...
StatusOr<CamenischShoupCiphertextWithRand> CommonEncryptAndGetRand(
  ...
  PJC_ASSIGN_OR_RETURN(CamenischShoupCiphertext ct,
                       CommonEncryptWithRand(ctx, ms, r, n, n_to_s, precomp,
                                             powers, g_fbe, ys_fbe, modulus));
...
StatusOr<CamenischShoupCiphertext> CommonEncrypt(
  ...
  PJC_ASSIGN_OR_RETURN(auto encryption_and_randomness,
                       CommonEncryptAndGetRand(ctx, ms, n, n_to_s, precomp,
                                               powers, g_fbe, ys_fbe, modulus));
...
StatusOr<std::unique_ptr<PublicCamenischShoup>> PublicCamenischShoup::FromProto(
  ...
  PJC_ASSIGN_OR_RETURN(
      CamenischShoupPublicKey public_key,
...
PrivateCamenischShoup::FromProto(
  ...
  PJC_ASSIGN_OR_RETURN(
      ...
      ParseCamenischShoupPublicKeyProto(ctx, public_key_proto));
  PJC_ASSIGN_OR_RETURN(
      CamenischShoupPrivateKey private_key,
