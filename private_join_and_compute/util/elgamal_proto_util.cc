...
StatusOr<ElGamalPublicKey> SerializePublicKey(
  ...
  PJC_ASSIGN_OR_RETURN(auto serialized_g,
                       public_key_struct.g.ToBytesCompressed());
  public_key_proto.set_g(serialized_g);
  PJC_ASSIGN_OR_RETURN(auto serialized_y,
                       public_key_struct.y.ToBytesCompressed());
...
StatusOr<ElGamalCiphertext> SerializeCiphertext(
  ...
  PJC_ASSIGN_OR_RETURN(auto serialized_u,
                       ciphertext_struct.u.ToBytesCompressed());
  ciphertext_proto.set_u(serialized_u);
  PJC_ASSIGN_OR_RETURN(auto serialized_e,
                       ciphertext_struct.e.ToBytesCompressed());
