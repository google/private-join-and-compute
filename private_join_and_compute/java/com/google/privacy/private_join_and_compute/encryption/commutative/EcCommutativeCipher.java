...
public final class EcCommutativeCipher extends EcCommutativeCipherBase {
   ...
   *
   * <p>// copybara:strip_begin(Remove sensitive comment) This implementation matches the C++
   ...
   *
   * <p>// copybara:strip_begin(Remove sensitive comment)
   *
   * <p>Security: The number of operations required to hash an input depends on the input, which
   * could lead to a timing attack: http://en.wikipedia.org/wiki/Timing_attack. //
   * copybara:strip_end
   *
